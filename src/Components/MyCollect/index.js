...
const MyCollect = (props) => {
  ...
  const onSubmit = () => {
    ...
    const nycRef = doc(
      firebaseDatabase,
      `posts/${props.postId}/comment/`,
      `${props.postId}_${Date.now()}_user.uid`
    );
    batch.set(nycRef, {
  ...
  return (
    <>
            ...
            <div className="comment_content">
              ...
              <div className="comment_content_postBox">
                ...
                <div>
                  ...
                  >
                    {props.postsData.likedBy?.length || 0} likes
                  </div>
                  ...
                  <div className="post__commentform">
                    ...
                    <button onClick={onSubmit}>
                      {isLoading ? <SpinningCircles /> : "release"}
                    </button>
                  </div>
                </div>
              </div>
      ...
      <div className="mypostImg_container">
        <div className="myCollect-imgbox">
          <div className="myCollect-imgbox-inner">
            <div
              className="myCollect-img"
              style={{
        ...
        <div className="post_interactive">
          <span>
            ...
            {props.postsData.likedBy?.length || 0}
          </span>
          <span>
            <span className="commentIcon"></span>
            {props.postsData.commentContent || 0}
          </span>
        </div>
      </div>
    </>
